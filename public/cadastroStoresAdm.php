...
<body>
  <div class="sidebar">
    ...
    <ul>
      <li><a href="./admHome.php"><i class="fa fa-home"></i> Home</a></li>
      <li><a href="#"><i class="fa fa-store"></i> Pedidos</a></li>
      <li><a href="./cadastroStoresAdm.php"><i class="fa fa-cart-plus"></i> Cadastrar lojas</a></li>
      <li><a href="./cadastroCidadesAdm.php"><i class="fa fa-city"></i> Cadastrar Cidades</a></li>
    </ul>
